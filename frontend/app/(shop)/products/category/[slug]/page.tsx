  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const filtered = filterByCategory(all, categoryName);
  ...
  return (
    <div className="min-h-screen py-12">
      <div className="container">
        ...
        <h1 className="text-4xl md:text-5xl font-serif font-bold text-cream mb-4 capitalize">{categoryName}</h1>
        <p className="text-muted mb-12">Browse our {categoryName.toLowerCase()} collection</p>
