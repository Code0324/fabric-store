...
export default function Navbar() {
  ...
  const megaMenuCategories: NavCategory[] = [
    {
      name: "Men's Wear",
      href: '/products?category=Men+Shalwar+Kameez',
      items: [
        { label: 'Shalwar Kameez',    href: '/products?category=Men+Shalwar+Kameez' },
        { label: 'Kurtas',            href: '/products?category=Men+Kurta' },
        { label: 'All Men',           href: '/products?category=Men+Shalwar+Kameez' },
      ],
    },
    {
      name: "Women's Wear",
      ...
      items: [
        { label: 'Lawn Unstitched',   href: '/products?category=Women+Lawn+Unstitched' },
        { label: 'Stitched Pret',     href: '/products?category=Women+Stitched+Pret' },
        { label: 'Embroidered',       href: "/products?category=Women's+Embroidered+Unstitched" },
        { label: 'Luxury Formal',     href: '/products?category=Luxury+Formal' },
        { label: 'Bridal & Wedding',  href: '/products?category=Bridal+%26+Wedding' },
        { label: 'All Women',         href: '/products?category=Women+Lawn+Unstitched' },
      ],
    },
    {
      name: 'Collections',
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Limelight',         href: '/products?brand=Limelight' },
        { label: 'Bonanza Satrangi',  href: '/products?brand=Bonanza+Satrangi' },
        { label: 'Junaid Jamshed',    href: '/products?brand=Junaid+Jamshed' },
        { label: 'Al Karam',          href: '/products?brand=Al+Karam' },
        { label: 'All Brands',        href: '/products' },
      ],
    },
  ];
